...
def plt_sst_ts(nt,ax):
    ...
    plt.errorbar(xdate,np.nanmean(y_store,axis=0),yerr=np.nanstd(y_store,axis=0),fmt='-g',ecolor=[.8,.85,.75],elinewidth=2,capsize=0)
...
# REGION BOUNDS
j0 = [650, 770, 940, 755, 670,  860]
jN = [1000, 820, 990, 805, 720,  875]
i0 = [460,530, 640, 790, 970,  735]
iN = [1025, 580, 690, 840, 1020, 750]
...
m2 = Basemap(llcrnrlon=lons2[0],llcrnrlat=lats2[0],urcrnrlon=lons2[1],urcrnrlat=lats2[1],resolution='i')
...
ymins = [24,25, 22, 25.5, 26, 24.5]
ymaxs = [32,32, 33, 32.5, 32, 31.5]

yt1 =   [25,26, 24, 27, 27, 26]
yt3 =   [31,31, 31, 31, 31, 30]
