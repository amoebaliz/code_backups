...
fil_dir = '/t3/workdir/liz/MODELS/CTROMS/PostProc/ctroms_vip_monthly_temps/'

yrs = np.arange(1976,1995+1)
n=0
fid0 = nc.Dataset('/t3/workdir/liz/MODELS/CTROMS/PostProc/ctroms_vip_monthly_temps/monthly_ct_temps_1976.nc')
...
for nyr in yrs:
    print nyr
    file = fil_dir + 'monthly_ct_temps_' + str(nyr) + '.nc'
...
ncid = nc.Dataset('/t3/workdir/liz/MODELS/CTROMS/PostProc/ctroms_vip_monthly_temps/monthly_max_temps.nc','a')
